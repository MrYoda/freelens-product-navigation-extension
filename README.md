...
`freelens-product-navigation-extension-0.1.11.tgz`, and install it. The extension
...
`0.1.11` archive. The version bump prevents a package-manager cache entry for
