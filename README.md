...
`freelens-product-navigation-extension-0.1.10.tgz`, and install it. The extension
...
`0.1.10` archive. The version bump prevents a package-manager cache entry for
